...
public class PermissionMonitorTest {
    ...
    @Test
    public void onUserStopped_LeakBlockingDisabled_RemovesBpfRules() throws Exception {
        int userId = MOCK_USER_ID1;
        int uid = MOCK_UID11;
        String packageName = MOCK_PACKAGE1;
        buildAndMockPackageInfoWithPermissions(packageName, uid);
    ...
    @Test
    public void onUidRemoved_LeakBlockingDisabled_EnablesLeakBlocking() throws Exception {
        int userId = MOCK_USER_ID1;
        int uid = MOCK_UID11;
        String packageName = MOCK_PACKAGE1;
        buildAndMockPackageInfoWithPermissions(packageName, uid);
